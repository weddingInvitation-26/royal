document.addEventListener('DOMContentLoaded', () => {
  ...
  (function createPetals() {
    ...
    for (let i = 0; i < petalCount; i++) {
      ...
      petal.style.background = ['#1B2A4A', '#2A4A7A', '#D4AF37', '#800020', '#F8F6F2'][Math.floor(Math.random() * 5)];
  ...
  const gradients = [
    'linear-gradient(135deg, #1B2A4A, #2A4A7A)',
    'linear-gradient(135deg, #D4AF37, #F0D68A)',
    'linear-gradient(135deg, #800020, #1B2A4A)',
    'linear-gradient(135deg, #2A4A7A, #F8F6F2)',
    'linear-gradient(135deg, #800020, #D4AF37)',
    'linear-gradient(135deg, #1B2A4A, #800020)'
  ];
